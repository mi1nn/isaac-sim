...
# Path to repository root directory (parent of the project directory)
SRB_REPO_DIR = SRB_DIR.parent

# Path to apps (experience) directory
SRB_APPS_DIR = SRB_DIR.joinpath("apps")

# Path to assets directory (kept as a sibling of the project directory)
SRB_ASSETS_DIR = SRB_REPO_DIR.joinpath("assets")
...
SRB_ASSETS_DIR_SPACE = SRB_ASSETS_DIR.joinpath("space_asset")
