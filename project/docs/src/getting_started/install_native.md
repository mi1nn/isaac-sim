...
Install Isaac Sim either by following the official instructions above or using the provided convenience [script](https://github.com/AndrejOrsula/space_robotics_bench/blob/main/project/scripts/install_isaacsim.bash):

```bash
./space_robotics_bench/project/scripts/install_isaacsim.bash "$HOME/isaac-sim"
```
...
Install Isaac Lab either by following the official instructions above or using the provided convenience [script](https://github.com/AndrejOrsula/space_robotics_bench/blob/main/project/scripts/install_isaaclab.bash):

```bash
./space_robotics_bench/project/scripts/install_isaaclab.bash "$HOME/isaaclab"
```
...
```bash
"$ISAAC_SIM_PYTHON" -m pip install --editable ./space_robotics_bench/project[all]
```

> **Note**: The `all` extra installs optional dependencies to support all workflows and improve usability. Feel free to check [`pyproject.toml`](https://github.com/AndrejOrsula/space_robotics_bench/blob/main/project/pyproject.toml) and adjust the extras to your needs.

### Setup CLI

Make the `srb` CLI command available in your shell through the provided [script](https://github.com/AndrejOrsula/space_robotics_bench/blob/main/project/scripts/setup_cli.bash):

```bash
./space_robotics_bench/project/scripts/setup_cli.bash
```
