...
from srb.core.env import OrbitalManipulationEnvVisualExtCfg, VisualExt
...
@configclass
class VisualTaskCfg(OrbitalManipulationEnvVisualExtCfg, TaskCfg):
    def __post_init__(self):
        TaskCfg.__post_init__(self)
        OrbitalManipulationEnvVisualExtCfg.wrap(self, env_cfg=self)
